...
FFLAGS = -O2 -fPIC -g -ftree-vectorize -xHost
...
#LIBS = ../Obj/MKLDFT/automatic_cell.o $(NETCDF_LIBS) $(SCALAPACK_LIBS) $(LAPACK_LIBS) $(MPI_LIBS) $(COMP_LIBS)
#LIBS = /Obj/MKLDFT $(NETCDF_LIBS) $(SCALAPACK_LIBS) $(LAPACK_LIBS) $(MPI_LIBS) $(COMP_LIBS)

INCFLAGS=
INCFLAGS=-I../Src -I../Src/MPI -I../Obj/MKLDFT ../Obj/MKLDFT/automatic_cell.o
INCFLAGS=-I../Src -I../Src/MPI -I../Obj/MKLDF
